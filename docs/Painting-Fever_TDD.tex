...
\begin{longtable}{|l|l|l|p{9cm}|}
	...
	\hline
	28.02.2026    & 0.1              & BZ-Interactive  & Initial creation of TDD document.                                                                                                       \\
	\hline
	01.03.2026    & 0.2              & BZ-Interactive  & Expanded system architecture, added detailed class diagrams, documented audio integration, and outlined future painting logic.          \\
	\hline
	01.03.2026    & 0.3              & BZ-Interactive  & Comprehensive expansion: added input/controls, GUI system, obstacle types, event system, settings, and level progression documentation. \\
	\hline
\end{longtable}
\newpage
...
\begin{itemize}[noitemsep]
	\item \textbf{Engine}: Godot 4.5 (C\# / .NET)
...
\begin{itemize}[noitemsep]
	...
	\item Shows current score/progress
	\item Contains reference to \texttt{PauseMenu}
...
\begin{longtable}{|l|l|}
	\hline
	\textbf{Feature}      & \textbf{File}           \\
	\hline
	Game State Management & GameManager.cs:47-73    \\
	\hline
	Level Instantiation   & LevelManager.cs:40-75   \\
	\hline
	Player Movement       & PlayerObject.cs:125-131 \\
	\hline
	Collision Detection   & PlayerObject.cs:133-142 \\
	\hline
	Music Playback        & SoundManager.cs:67-74   \\
	\hline
	Sticky Effect         & StickyArea.cs:59-77     \\
	\hline
\end{longtable}
