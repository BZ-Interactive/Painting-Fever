...
public partial class LevelManager : Node
{
    ...
    public void LoadNextLevel()
    {
        ...
        // Same difficulty next level, player must return to menu if they finish this difficulty
        int newIndex = CurrentLevel.LevelIndex + 1;
        Difficulty currentDifficulty = CurrentLevel.Difficulty;

        UnloadCurrentLevel();
        InstantiateLevel(currentDifficulty, newIndex);
    }
}
